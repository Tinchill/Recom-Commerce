--@exclude_input=recom_commerce.item_dim
...
--维表
--30天内购买top-500的品牌: brand_top500_alipay_dim
--30天内购买top-1w的品牌 : brand_top1w_alipay_dim
--从中再选出top-20个品牌, top-2个类目(cate1,cate2)
...
create table if not exists brand_top20_item_dim LIFECYCLE  180 as
